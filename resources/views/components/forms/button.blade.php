...
$variants = [
    ...
    'alternative' => 'text-gray-900 bg-whit border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10  focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700',
...
$classes = 'focus:ring-4 font-medium rounded-lg text-sm px-5 py-2.5 focus:outline-none cursor-pointer ' . ($variants[$variant] ?? $variants['default']);
?>
